/**************************************************************
  modifications 2013 G. Horton-Smith, Kansas State University
***************************************************************/
...
/* Modification: Glenn Horton-Smith -- removed -x and default .dbd features */

/* Usage:
 *  softIoc [-D softIoc.dbd] [-h] [-S] [-s] [-a ascf]
 *	[-m macro=value,macro2=value2] 
 *	[st.cmd]
 *
...
int main(int argc, char *argv[])
{
    ...
    if (dbd_file != NULL && dbLoadDatabase(dbd_file, NULL, NULL)) {
